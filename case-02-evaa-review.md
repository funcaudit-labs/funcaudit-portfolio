...
**Scope:** ~10,800 LoC FunC. Line-by-line review of core value flow.
...
- principal serialization: pack/unpack bit-widths consistent (int64), no truncation — OK
- Pyth oracle: price>0, staleness (now > ts + ttl), feed->asset mapping — enforced
