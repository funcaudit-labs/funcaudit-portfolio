...
Independent smart-contract security research on the TON blockchain (FunC).
This repository documents self-directed security reviews performed to
demonstrate methodology and depth. Reviews are independent and not
commissioned; all work was done against public source code and testnet.
...
### Tooling used
FunC toolchain, Blueprint, @ton/sandbox, custom PoC test harness,
manual invariant analysis.

## Services
Independent security review of TON / FunC smart contracts:
jetton, vault, vesting, minter, and DEX-style contracts.
Fixed-price reviews of individual contracts available.

Contact: Telegram @sokolovsky_ruslan
